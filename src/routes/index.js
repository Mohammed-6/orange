...
import UiToasts from "../pages/Ui/UiToast";
  ...
  //Employees
  //employees
import AllEmployees from "../main-forms/Employees/employees/all-employees/AllEmployees";
import AddEmployee from "../main-forms/Employees/employees/add-employee/AddEmployee";
...
const authProtectedRoutes = [
  ...
  //Employees
  //employees
  {path: '/employees/employees/all-employees', component: AllEmployees},
  {path: '/employees/employees/add-employee', component: AddEmployee},
